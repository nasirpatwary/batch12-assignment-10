          ...
          <div key={idx} className="relative group cursor-pointer">
            ...
            <div className="absolute top-4 right-4">
              <div className="relative">
                <span className="flex items-center justify-center size-8 bg-white dark:bg-gray-800 rounded-full text-primary dark:text-primary group-hover:bg-primary group-hover:text-white shadow-md transition">
                ...
                <div className="absolute top-4 scale-y-0 group-hover:scale-y-100 transition-all duration-500 origin-top group-hover:top-10 space-y-2">
                  {[FaFacebookF, FaTwitter, FaLinkedinIn].map((Icon, i) => (
                    <span
                      key={i}
                      className="flex items-center justify-center size-8 bg-white dark:bg-gray-800 rounded-full text-primary dark:text-primary shadow-md hover:bg-primary hover:text-white transition"
                    >
                      <Icon />
                    </span>
                  ))}
