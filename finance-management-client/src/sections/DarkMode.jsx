...
const DarkMode = () => {
  ...
  return (
    <div className="fixed top-40 z-50 right-0 flex items-center justify-center rounded-l-full">
      {/* <input
      ...
      <label className="inline-flex items-center relative">
        <input
          ...
          id="toggle"
        />
        <div className="relative w-[110px] h-[50px] bg-white peer-checked:bg-zinc-500 rounded-l-full after:absolute after:content-[''] after:w-[40px] after:h-[40px] after:bg-gradient-to-r peer-checked:after:from-zinc-900 peer-checked:after:to-zinc-900 after:rounded-full after:top-[5px] after:left-[5px] active:after:w-[50px] peer-checked:after:left-[105px] peer-checked:after:translate-x-[-100%] shadow-sm duration-300 after:duration-300 after:shadow-md"></div>
        <svg
          height="0"
          width="100"
          viewBox="0 0 24 24"
