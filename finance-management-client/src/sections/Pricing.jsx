...
const Pricing = () => {
  ...
  return (
    <Container className="mt-16 max-w-5xl mx-auto">
      <div className="text-center space-y-2">
        ...
        <div className="border-2 border-primary bg-white mt-8 rounded-full w-fit mx-auto flex">
          <button
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 items-center gap-6 mt-12">
        <div className="card bg-gray-50 text-black border-4 h-fit border-base-100 shadow-sm">
        ...
        <div className="card bg-gray-50 border-4 h-fit text-black border-base-100 shadow-sm">
          <div className="card-body">
            <span className="badge badge-xs badge-warning">Most Popular</span>
            <div className="flex justify-between">
